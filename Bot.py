...
from Tur import ConvertionExeption, CryptoConverter
...
def start(message):
    ...
    bot.send_message(message.chat.id, 'Добрый день, я бот для конвертации валют. Нажмите кнопку Помощь, чтобы посмотреть как со мной работать'.format(message.from_user),
                     reply_markup=marcup)
